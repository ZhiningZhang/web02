...
# --- Configure Matplotlib for Chinese characters on Windows---
# Using 'Microsoft YaHei UI', which is a standard font on Windows.
plt.rcParams['font.sans-serif'] = ['Microsoft YaHei']
plt.rcParams['axes.unicode_minus'] = False # Solves the issue of the minus sign not displaying
